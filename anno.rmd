...
meanplots$gene[6:10] <- top5

meanplots <- mutate(meanplots, gene = factor(gene, levels = c("RBFOX1","DSCAM","SORCS2","PKD1L2","PRKN")))

ggplot(meanplots,aes(gene,c_m,fill=group)) +
  geom_col(position="dodge") +
  geom_errorbar(aes(gene,ymin=c_m-c_sds,ymax=c_m+c_sds),width=0.2,position=position_dodge(0.9))
```
