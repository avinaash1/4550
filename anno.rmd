...
kable(p_val_adj,caption="Table 2. Bonferroni p-values")
...
colnames(mtable) <- c("Control mean V/GBP", "Control SDev", "Obese Mean V/GBP", "Obese SDev", "Mean Difference", "Bonferroni p-value")

# mean diff table
kable(mtable,caption="Table 3. Genes with the Greatest Difference in Number of Variants")
