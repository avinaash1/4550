...
```
# Abstract
With the prevalence of obesity nearly doubling in the past two decades, it has become increasingly important to study this illness. Contributing to a variety of diseases, the obesity epidemic has resulted in an increase in heart disease, stroke, and type 2 diabetes as well. Additionally, in 2008 obesity was associated with almost $150 billion in American Healthcare system costs.<sup>1</sup> Due to obesity’s polygenic nature, many recent studies have been focusing on studying the role of genetics in obesity onset. Mutations in hypothalamic specific genes suggest that this brain region plays a role in onset.<sup>2</sup>Furthermore, many genome-wide association studies (GWAS) have shown that hunger signaling has a genetic component as well.<sup>4</sup> Our project serves to study obesity by conducting whole exome sequencing (WES) analysis. This was done by comparing hypothalamic neurons from obese patients to a reference genome. The pipeline used indicated Single Nucleotide Variants (SNVS) and Insertion/deletion (Indel) base pair sequences present when comparing the two genomes.<sup>6</sup> Our study offered an exploratory data analysis into genetic variants present in individuals with extreme obesity, and identifies potential routes for further obesity genetics research. Results indicated that our control group had more genetic variants existed in the control, normal weight group. However this could be attributed due to the fact that the control group dna sequences were obtained from car crash victims. Further analysis indicated that RBFOX1, DSCAM, SORCS2, PKD1L2, and PRKN were the genes most responsible for genetic variants present in super obese patients. Further research can be conducted involving these specific genes role in obesity. 
